 ...
 *
 * Why not 84 per-mission ticks? At 84 missions, each one would be 4-5px
...
function FinishedScreen() {
    return (
        ...
        >
            ...
            >
                84 missions across eight skill trees. You used Bitcoin, Lightning, Nostr, and eCash for real, and you actually understand
