 ...
 *
 * Why not 67 per-mission ticks? At 67 missions, each one would be 4-5px
...
function FinishedScreen() {
    return (
        ...
        >
            ...
            >
                67 missions across eight skill trees. You used Bitcoin, Lightning, Nostr, and eCash for real, and you actually understand
