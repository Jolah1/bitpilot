 ...
 *
 * Why not 87 per-mission ticks? At 87 missions, each one would be 4-5px
...
function FinishedScreen() {
    return (
        ...
        >
            ...
            >
                87 missions across eight skill trees. You used Bitcoin, Lightning, Nostr, and eCash for real, and you actually understand
