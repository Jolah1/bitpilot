...
export const JOURNEYS: Journey[] = [
    ...
    },
    {
        ...
        audience: 'For Nigerians sending money home or receiving support',
        promise: 'Compare naira costs, prepare the receiver, and practise a safe Lightning transfer.',
        tree: 'lightning',
        missions: [106, 10, 107, 21, 80, 23, 24, 108, 109, 110],
        minutes: 50,
        outcome: 'I can compare remittance costs and send money home safely.',
        capabilities: [
            { mission: 23, label: 'Can create a Lightning invoice' },
